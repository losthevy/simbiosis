    ...
    return (
        <div className="flex-1 flex flex-col w-full h-full overflow-hidden bg-background-light dark:bg-background-dark relative">
            ...
            <button
                ...
                className="fixed bottom-6 right-6 w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-2xl shadow-blue-600/30 flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 z-50 group border-2 border-white dark:border-gray-800"
